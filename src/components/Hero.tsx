      ...
      <div className="text-center max-w-4xl">
        ...
        >
          <h1 className="text-6xl md:text-8xl font-bold mb-4">
            {"KASHIF ALAM".split("").map((letter, index) => (
              <motion.span
                key={index}
        ...
        <motion.div
          ...
          className="space-y-4"
        >
          <div className="text-lg text-gray-400">AI Engineer</div>
          <div className="text-blue-400">Building Intelligent Systems • Python • NLP • Deep Learning • Computer Vision</div>
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <Button asChild variant="default" size="lg" className="bg-gradient-to-r from-blue-400 via-purple-500 to-pink-400 hover:from-blue-500 hover:via-purple-600 hover:to-pink-500 text-white font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
