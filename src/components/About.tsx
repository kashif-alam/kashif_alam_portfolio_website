...
import profileImage from 'figma:asset/8902dfabb2c3e2d645b398bc36fef14dac5b2f03.png';
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              With a passion for AI and machine learning, I specialize in developing intelligent systems 
              and data-driven solutions. My expertise includes machine learning, natural language processing, 
              deep learning, and computer vision technologies.
            </p>

            <p className="text-gray-300 text-lg leading-relaxed">
              I have experience in data analysis, visualization, and implementing AI solutions in various projects. 
              I'm dedicated to making AI accessible and impactful for real-world applications.
            </p>
