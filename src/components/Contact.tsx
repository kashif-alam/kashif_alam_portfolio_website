...
export function Contact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await emailjs.send(
        'service_xmmxw2n', // Replace with your EmailJS service ID
        'template_ieuvi7p', // Replace with your EmailJS template ID
        {
          from_name: formData.name,
          from_email: formData.email,
          message: formData.message,
          to_email: 'kashifalam.ai@gmail.com'
        },
        'PEthKaIcEUywEfUsN' // Replace with your EmailJS public key
      );
      ...
      setStatusMessage(`Failed to send message: ${error?.text || 'Please check your EmailJS configuration.'}`);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "kashifalam.ai@gmail.com", href: "mailto:kashifalam.ai@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+923416121924", href: "tel:+923416121924", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/kashif-alam", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/kashifalams/", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2026 Kashif Alam. Engineering the future with AI.
          </p>
        </motion.div>
      </div>
    </section>
