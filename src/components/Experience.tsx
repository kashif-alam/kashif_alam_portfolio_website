...
export function Experience() {
  const experiences = [
    {
      title: "AI Engineer",
      company: "C4micro Tech",
      period: "July 2025 - Present",
      description: "As a Computer Vision Engineer at Niostem and RAG Engineer at Kosmoz.ai, I drove AI projects. At Niostem, I handled data preprocessing, image segmentation, annotation, and model development for hair follicle analysis using Python and deep learning frameworks. At Kosmoz.ai, I built RAG pipelines with vector embeddings and knowledge retrieval to boost LLM accuracy. I deployed scalable AI solutions, created visualization dashboards, and applied analytical/problem-solving skills to complex datasets. I delivered dedicated, punctual, high-quality performance throughout.",
      icon: GraduationCap,
      skills: ["Python", "PyTorch / TensorFlow", "OpenCV", "Computer Vision", "Retrieval-Augmented Generation (RAG)", "Vector Embeddings", "Vector Databases", "Large Language Models (LLMs)", "Model Development & Deployment", "Data Preprocessing", "Data Analysis & Visualization"]
    },
    {
      title: "AI Engineer Intern",
      company: "SecureNetics",
